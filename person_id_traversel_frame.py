...
def read_track_file(track_file):
    ...
    with open(track_file, 'r') as fin:
        for line in fin.readlines():
            ...
            person_show_in_frames = person_2_frames.get(person_id, [])
            person_show_in_frames.append(frame_idx)
            person_2_frames[person_id] = person_show_in_frames
    return frame_2_person_list, person_2_frames
...
if __name__ == '__main__':
    ...
    frame_2_person_list, person_2_frames = read_track_file(person_track_file)
        ...
        if frame_idx in frame_2_face:
            ...
            for face in face_list:
                ...
                for person in person_list:
                    ...
                    if is_rectangle_in(face_box, person_box):
    ...
    #print(person_2_face)
    video_file = '/home/avs/Codes/PaddleDetection/LNBGvsZJCZ_615.ts'
    output_dir = 'output'
    cnt_thresh = 2
